...
def run():
    with app.app_context():
        ...
        print(f"  admin@acme.com        — Admin")
        print(f"  pm1@acme.com          — Project Manager (Priya Mendez)")
        print(f"  pm2@acme.com          — Project Manager (Jordan Lee)")
        print(f"  dev1@acme.com         — Team Member (Sam Chen)")
        print(f"  dev2@acme.com         — Team Member (Anika Patel) [over-allocated]")
        print(f"  dev3@acme.com         — Team Member (Marcus Torres)")
        print(f"  exec@acme.com         — Stakeholder")
